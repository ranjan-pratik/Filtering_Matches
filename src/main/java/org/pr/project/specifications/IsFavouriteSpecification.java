...
public class IsFavouriteSpecification extends AbstractSpecification<Boolean> {

	public IsFavouriteSpecification(IsTrueStrategy isTrueFilteringStrategy) {
		this.field = "isFavourite";
		this.strategy = isTrueFilteringStrategy;
	}
